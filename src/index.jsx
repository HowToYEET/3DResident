...
function LoadingModel() {
  return (
    <div className="place-content-center justify-center m-[300px] ml-[600px]"><div role="status">
...
const router = createBrowserRouter(
  createRoutesFromElements(
    <Route element={<App />}>
      ...
      <Route path="/Apartments/:index" errorElement={<ErrorPage></ErrorPage>} element={<Suspense fallback={<LoadingModel />}> <TheModel /> </Suspense>} />
      <Route path="/showroom" errorElement={<ErrorPage></ErrorPage>} element={<TheModel />} />
    </Route>
  )
)
